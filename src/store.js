...
// Optionally, persist the `auth` reducer (e.g., for token persistence)
const authPersistConfig = {
  key: 'auth',
  storage,
  whitelist: ['token', 'isAuthenticated'], // Persist token and isAuthenticated
};
...
const rootReducer = combineReducers({
  homepage: homepageReducer,
  allSections: persistReducer(allSectionsPersistConfig, allSectionsReducer),
  auth: persistReducer(authPersistConfig, authReducer), // Add the auth reducer
  [apiSlice.reducerPath]: apiSlice.reducer,
});
